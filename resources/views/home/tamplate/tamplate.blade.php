            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        @endif
                        <li class="sidebar-item {{
                            $title=='Siswa | BK Administration' ? 'active' : ''
                        }}">
                        ...
                        <li class="sidebar-item {{$title =='Users | BK Administration' ? 'active':''}}">
                        ...
                        <li class="sidebar-item {{
                            $title=='Jenis Pelanggaran | BK Administration' ? 'active' : ''
                        }}">
                        ...
                        <li class="sidebar-item  {{
                            $title=='Jenis Kebaikan | BK Administration' ? 'active' : ''
                        }}">
                        ...
                        <li class="sidebar-item {{
                            $title=='Log Perilaku | BK Administration' ? 'active' : ''
                        }}">
                        ...
                        <li class="sidebar-item  {{
                            $title=='Tambah Log Siswa | BK Administration' ? 'active' : ''
                        }}">
